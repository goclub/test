...
func TestBool(t *testing.T) {
	{
		...
		testRun(10000, func(i int) (_break bool) {
			if xtest.Bool() { trueCount++ } else { falseCount++ }
			return
		})
...
func TestTrueLikelihood(t *testing.T) {
	{
		...
		falseCount := 0
		testRun(10000, func(i int) (_break bool) {
			if xtest.TrueLikelihood(0) { trueCount++ } else { falseCount++ }
			return
		})
	...
	}
	{
		...
		falseCount := 0
		testRun(10000, func(i int) (_break bool) {
			if xtest.TrueLikelihood(10) { trueCount++ } else { falseCount++ }
			return
		})
	...
	}
	{
		...
		falseCount := 0
		testRun(10000, func(i int) (_break bool) {
			if xtest.TrueLikelihood(20) { trueCount++ } else { falseCount++ }
			return
		})
	...
	}
	{
		...
		falseCount := 0
		testRun(10000, func(i int) (_break bool) {
			if xtest.TrueLikelihood(100) { trueCount++ } else { falseCount++ }
			return
		})
